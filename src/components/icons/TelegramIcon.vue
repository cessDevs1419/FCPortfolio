<template>
    <a href="https://t.me/frncs12357" class="rounded-circle d-flex justify-content-center align-items-center socmed-icons" v-bind:class="[mode ? 'bg-white':'primary-color']">
